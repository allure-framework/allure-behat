...
class FeatureContext implements Context
{
    ...
    {
        if (is_dir($dir = __DIR__ . '/../../build' . DIRECTORY_SEPARATOR . 'behat')) {
    ...
    {
        $dir = __DIR__ . '/../../build' . DIRECTORY_SEPARATOR . 'behat' . DIRECTORY_SEPARATOR .
...
EOL;
    ...
    public function iRunBehat($argumentsString = '')
    {
        ...
        $this->process = new Process(
            [
                ...
                ...\preg_split('#\s+#', strtr($this->options, ['\'' => '"', '"' => '\"'])),
            ]
        );
    ...
    {
        $text = strtr((string) $expectedText, [
            '\'\'\'' => '"""',
